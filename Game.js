class Game {
            ...
            for (var plr in allPlayers) {
                ...
                if (index === player.index) {
                    ...
                    if (player.characterSelected == 1 && equipamentos.index == 1) {
                        player.changeImage(warriorStop);
    ...
    //fazer a camera andar com o personagem e bater nas bordas para nao ultrapassar o mapa
    //setar posiçao proporcional jogadores
    //localizaçao equipamento
    //Onde carregar as animacoes
    ...
    handlePlayerControls() {
        ...
        if (keyIsDown(RIGHT_ARROW)) {
           ...
           player.changeAnimation("andando",warriorWalking);
        }
