class Form {
  constructor() {
    ...
    this.character1 = createImg("./img/Guerreiro.png");
    this.character2 = createImg("./img/Assassina-1.png");
    this.character3 = createImg("./img/Cientista.png");
    this.character4 = createImg("./img/Robo.png");
    this.characterSelected = undefined;
    this.characterSelectedImg1 = createImg("./img/Guerreiro.png");
    this.characterSelectedImg2 = createImg("./img/Assassina-1.png");
